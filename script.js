const sections = {
    home: {
      title: "Hi, It's <span>Yashika</span>",
      subtitle: "I'm a <span>Web Developer</span>",
  ...
  // Function to update the dynamic text content
